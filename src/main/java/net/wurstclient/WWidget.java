...
import minegame159.meteorclient.gui.widgets.WView;
...
public abstract class WWidget {
    ...
    protected abstract void move(minegame159.meteorclient.gui.widgets.WWidget widget, double deltaX, double deltaY,
    ...
    protected abstract void onRenderWidget(minegame159.meteorclient.gui.widgets.WWidget widget, GuiRenderer renderer,
    ...
    protected boolean propagateEvents(minegame159.meteorclient.gui.widgets.WWidget wWidget) {
        return !(parent instanceof WView) || parent.propagateEvents(wWidget);
    }
